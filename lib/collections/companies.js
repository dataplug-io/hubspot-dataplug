...
const source = dataplug.source(
  config.declaration.extended((declaration) => declaration
    .parameters({
      recentlyCreated: {
        description: 'Fetch companies which was created in the last 30 days, or the 10k most recently created records sorted by the date the companies were created.'
      },
      recentlyUpdated: {
